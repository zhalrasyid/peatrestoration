                ...
                <div class="project-detail row">
                    ...
                    <div class="project-infos col-md-12">
                        <div class="contact-form-inner">
							<h2 class="project-title">Buffer </h2>                            
							<br/>
							<h3 class="project-title">Make Layer buffered</h3>
							<?php echo form_open(base_url()."index.php/spatial/runbuffer");?>
							<form method="post" action="" name="frmbuffer">
								...
								<p>
								<label>Buffer Size (meter): </label>
								<?php echo form_input("buffsize", "", "hidden");?>
								<input type="text" name="buffsize" size=4></input>											
								</p>
								<p>
								...
								<input type="submit" class="mainBtn" name="submit_buffer" value="Run Buffer" />
								</p>		
							</form>
